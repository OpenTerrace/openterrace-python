...
ot = openterrace.Simulate(t_end=3600*2, dt=0.05, sim_name='tutorial7')
...
fluid.select_output(times=[30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330, 360, 390, 420, 450, 480, 510, 540, 570, 600, 900, 1800, 3600, 5400])
...
bed.select_output(times=list(range(0,7200,300)))
